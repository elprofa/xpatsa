    ...
    <CardClientDetailStc>
      ...
      <Row>
        ...
        <Col lg={4}>
          ...
          <p className="value">{client.firstname}</p>
        </Col>
        <Col lg={4}>
          <p className="label">Téléphone : </p>
          <p className="value">{client.telephone}</p>
        </Col>
      </Row>
      <Row>
        <Col lg={4}>
          <p className="label">Pays:</p>
          <p className="value">{client.country}</p>
        </Col>
        <Col lg={4}>
          <p className="label">ville :</p>
          <p className="value">{client.ville}</p>
        </Col>
      </Row>
      <Row classNamerowAction>
        <Col lg={8}></Col>
        <Col lg={4}>
          <Link href={"/client/update/" + props.id_client}>
            <a className="btn">Modifier le client</a>
          </Link>
        </Col>
      </Row>
    </CardClientDetailStc>
