...
import {
  LISTE_TRANSACTION_BOX,
  LISTE_TRANSACTION_TOTAL,
} from "../CardCountTransactionWidget";
...
function FormSaveTransaction() {
  ...
  for (i = 0; i < response.data?.clients.length; i++) {
    options.push({
      value: response.data?.clients[i].id,
      label:
        response.data?.clients[i].firstname +
        " " +
        response.data?.clients[i].name,
    });
  }
  ...
  const test = async (e) => {
    ...
    let quatreVingtFraisDh =
      document.getElementById("quatreVingtFraisDh").value;
  ...
  return (
    <FormSaveTransactionStc>
      <h2 className="cardTitre">
        ...
        <span className="appercuTaux" id="appercuTaux">
          .....
        </span>
        )
      </h2>
          ...
          <Row>
            ...
            <Col lg={4}>
              <div className="form-group">
                <label>
                  {" "}
                  A envoyer (
                  <span className="appercuTaux" id="transactionSentDevise">
                    .....
                  </span>
                  )
                </label>
            ...
            <Col lg={4}>
              <div className="form-group">
                <label>
                  A recevoir (
                  <span className="appercuTaux" id="transactionReceivedDevise">
                    .....
                  </span>
                  )
                </label>
            ...
            <Col lg={4}>
              <div className="form-group">
                <label>
                  Frais(
                  <span className="appercuTaux" id="transactionFeesDevise">
                    .....
                  </span>
                  )
                </label>
            ...
            <Col lg={4}>
              <div className="form-group">
                <label>
                  Autre frais (
                  <span className="appercuTaux" id="transactionOtherFeesDevise">
                    .....
                  </span>
                  )
                </label>
            ...
            <Col lg={4}>
              <div className="form-group">
                <label>
                  Total (
                  <span className="appercuTaux" id="transactionTotalDevise">
                    .....
                  </span>
                  )
                </label>
            ...
            <Col lg={12}>
              ...
              <input
                ...
                id="quatreVingtFrais"
                readOnly
                name="quatreVingtFrais"
                placeholder="Frais"
              />
              <input
                type="hidden"
                id="quatreVingtFraisDh"
                readOnly
                name="quatreVingtFraisDh"
                placeholder="Frais"
              />
              <input
                type="hidden"
