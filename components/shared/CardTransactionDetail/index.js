    ...
    <CardTransactionDetailStc>
      ...
      <Row>
        ...
        <Col lg={3} className="blockCol">
          ...
          <p className="value">{transaction.modalite}</p>
        </Col>
        <Col lg={3} className="blockCol">
        ...
        <Col lg={3} className="blockCol">
          ...
          <p className="value">
            {transaction.paid ? (
              <span className="yes" onClick={handleShow}>
                Payé <a>(Facture)</a>
              </span>
            ) : (
              <span className="no">Non Payé</span>
            )}
          </p>
        </Col>
      </Row>
      <Row>
        <Col lg={8} className="blockCol">
          ...
          <p className="value">
            ...
            <span className="iconDetailUser" title="Détail du client">
              <Link href={"/client/" + transaction?.client?.id}>
                <a>
                  <BsEye />
                </a>
              </Link>
        ...
        <Col lg={4} className="blockCol">
          ...
          <p className="value">{transaction.telephone}</p>
        </Col>
      </Row>
      ...
      <Row classNamerowAction>
        <Col lg={8}></Col>
        <Col lg={4}>
          <Link href={"/transaction/update/" + props.id_transaction}>
            <a className="btn">Modifier la transaction</a>
          </Link>
        </Col>
      </Row>
    </CardTransactionDetailStc>
