...
const Example = (props) => {
  ...
  return (
    <Form>
      ...
      <Row form className='mt-5 mb-5'>
      <Col lg={12} className='d-flex flex-wrap justify-content-center mt-1 w-100'>
        <Label for="exampleCustomSelectDisabled">Montant de la transaction</Label><br></br>
        </Col>
        <Col lg={6} className='d-flex flex-wrap justify-content-center my-3 w-50' >
        <Input placeholder="contact destinataire" />
        </Col>

        <Col lg={6} className='d-flex flex-wrap justify-content-center mt-3 w-50' >
